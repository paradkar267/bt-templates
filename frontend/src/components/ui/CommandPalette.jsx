      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[10vh] px-4 sm:px-6">
          ...
          >
            ...
            <div data-lenis-prevent="true" className="max-h-[60vh] overflow-y-auto overscroll-contain p-2 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-white/10">
              {loading ? (
